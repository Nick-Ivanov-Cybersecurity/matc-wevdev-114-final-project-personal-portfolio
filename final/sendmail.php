...
<head>
	<meta charset="UTF-8">
    <meta name="description" content="WEBDEV-114 HTML Contact Form Example">
    <meta name="keywords" content="WEBDEV-114 HTML Contact Form Example">
	<title>WEBDEV-114 HTML Contact Form Example</title>
...
<?php
  ...
  //Set admin email for email to be sent to (use you own MATC email address)
    $admin_email = "ivanovn@gmatc.matc.edu"; 
